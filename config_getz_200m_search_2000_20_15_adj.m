...
% output behaviour: 
results_dir = '.\output\';
proj_subdir = 'getz_200m\2000_20_15_adj\'; 
fig_subdir = 'fig\'; 
shp_subdir = 'shp\'; 
...
path_to_start_end_shp = '.\input\Getz1_2\Main_channels_adjusted.shp'; 
...
search_step = 2000;               % distance to step away from last known centerline point to construct search profile [m]
...
max_no_cent_pts = 40;             % when to stop looking for centerline end point [-]
crack_thr = 15;                    % if new centerline point's depth w.r.t. last known point is greater than threshold, pick next best point instead [m]

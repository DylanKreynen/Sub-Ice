...
% output behaviour: 
results_dir = '.\output\';
proj_subdir = 'getz_200m\2000_40_5\'; 
fig_subdir = 'fig\'; 
shp_subdir = 'shp\'; 
...
crack_thr = 5;                    % if new centerline point's depth w.r.t. last known point is greater than threshold, pick next best point instead [m]

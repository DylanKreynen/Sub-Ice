...
% output behaviour: 
results_dir = '.\output\';
proj_subdir = 'getz_200m\adjusted_start\'; 
fig_subdir = 'fig\'; 
shp_subdir = 'shp\'; 
...
crack_thr = 20;                    % if new centerline point's depth w.r.t. last known point is greater than threshold, pick next best point instead [m]

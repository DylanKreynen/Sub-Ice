...
% output behaviour: 
results_dir = '.\output\';
proj_subdir = 'getz_200m\2000_40_12\'; 
fig_subdir = 'fig\'; 
shp_subdir = 'shp\'; 
...
no_cent_samp_pts = 40;            % number of sampling points on search profile [-]
...
crack_thr = 12;                    % if new centerline point's depth w.r.t. last known point is greater than threshold, pick next best point instead [m]
